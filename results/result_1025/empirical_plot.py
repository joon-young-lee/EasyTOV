...
file_name0 = './results/result_1025/empirical.dat'
file_name1 = './results/result_1025/empirical_nocrust.dat'
...
plt.text(4, 1.5, f'Maximum mass with crust {np.max(M0):.2f}\nMaximum mass witout crust {np.max(M1):.2f}', fontsize=17)
plt.text(4, 1.3, r'central density up to $\sim 5000MeV/fm^3$', fontsize = 15)
